...
- (void)viewDidLoad
{
    ...
    _scoreLabel.center = CGPointMake(self.view.frame.size.height/2, _scoreLabel.center.y);
}
...
- (void)update
{
    ...
    _scoreLabel.text = [NSString stringWithFormat:@"%d | %d", [box2d score1], [box2d score2]];
}
